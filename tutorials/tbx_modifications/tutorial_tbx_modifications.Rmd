...
Note: this presentation is made with [Rmarkdown](http://rmarkdown.rstudio.com/). When rendered, it is viewable [online]() and the code is available on [GitHub](https://github.com/OHI-Science/ohimanual/blob/master/tutorials/tbx_modifications/tutorial_tbx_modifications.Rmd).
