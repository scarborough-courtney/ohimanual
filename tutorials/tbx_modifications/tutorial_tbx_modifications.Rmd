...
Note: this presentation is made with [Rmarkdown](http://rmarkdown.rstudio.com/). When rendered, it is viewable [online](http://htmlpreview.github.io/?https://github.com/OHI-Science/ohimanual/blob/master/tutorials/tbx_modifications/tutorial_tbx_modifications.html#1) and the code is available on [GitHub](https://github.com/OHI-Science/ohimanual/blob/master/tutorials/tbx_modifications/tutorial_tbx_modifications.Rmd).

## Add a new variable to a goal model 
