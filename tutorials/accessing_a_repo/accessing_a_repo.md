...
* **Windoww**: go to command line in Windows (Start > Run > cmd)  
  
Substitute your user information with the user John Doe:
...
\*\* With either approach, we recommend cloning the repository to this file path: `~/github/ohi-[assessment]`. This will make collaborating much simpler since everyone will work with the same filepath.
