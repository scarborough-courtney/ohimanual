...
* **clone**: telecargar a su ordenador las versiones en la online con la capacidad de sincronizar activada
...
Siga estos pasos los cuales puede encontrar en el Manual del Indice de Salud del Océano en la sección [Instalando la Caja de Herramientas](http://ohi-science.org/manual/#installing-the-toolbox) para obtener información más detallada. 
...
5. Envie su nombre de usuario Github a [Julie Stewart Lowndes](lowndes@nceas.ucsb.edu) para que pueda finalmente: 
