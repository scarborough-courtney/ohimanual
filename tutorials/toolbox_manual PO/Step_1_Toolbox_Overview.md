...
3. Become familiar [using the Toolbox App]()
...
**Requirements**: familiarity with the Toolbox application and proficiency with data management and the coding language **R** (See: [Step_3]()). Proficiency in spatial software such as ArcGIS may also be required, depending on the regional assessment strategy.  (See: [Step_4]() and [Step_5]()).
