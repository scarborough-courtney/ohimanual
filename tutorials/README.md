...
1. Install the [latest version of R](http://cran.r-project.org/) at: http://cran.r-project.org/.
2. Launch the [Toolbox Application](http://ohi-science.org/pages/install.html) (see instructions at: http://ohi-science.org/pages/install.html).
