...
A: A lot of deliberation went into defining the ten goals, and they seem to do a pretty good job of covering many if not most ocean uses, so additional goals may noy=t be necessary. But it could be that they eclipse or replace an existing goal. 
...
Tourism & Recreation
Q: How do I calculate the sustainability term for T&R?
...
Data included in pressures calculations are accessed in the same manner as any other data layer, and rescaled from 0-1 with an appropriate reference point. For further information, see HowTo_GatherAppropriateData and HowTo_CalculatePressures from ohi-science.org.
