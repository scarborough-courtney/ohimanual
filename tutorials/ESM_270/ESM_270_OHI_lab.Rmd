...
# in your R Console, paste the following, replacing the xxx with your 3-letter code.
key = 'xxx'
...
# Note: if you have chosen any of the following repositories, you will need to make the following substitutions for subcountry2014:
#       chn -> province2015
