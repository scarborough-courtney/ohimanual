...
For regional studies, the goals are calculated for each reporting region (i.e., state, province, etc.) using the best information available at this spatial scale.  Ultimately, the scores of the reporting units are combined to give a comprehensive picture of coastal ocean health.  
